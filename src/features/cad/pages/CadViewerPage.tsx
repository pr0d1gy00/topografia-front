...
import { FiArrowLeft, FiMinus, FiPlus, FiMaximize, FiEye, FiEyeOff, FiTrash2, FiLayers } from "react-icons/fi";
import { fetchPoints, fetchProjectById } from "../../topography/api/points";
import { fetchStations } from "../../topography/api/stations";
import { fetchLayers, createLayer, toggleLayerVisibility } from "../../topography/api/layers";
...
export const CadViewerPage = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-[#0F172A] overflow-hidden">
      ...
      {/* --- UI FLOTANTE (HTML) - FUERA DEL STAGE --- */}
